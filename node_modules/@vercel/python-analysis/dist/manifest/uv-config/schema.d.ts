 ...
 */
export declare const UvConfigWorkspaceSchema: z.ZodType<UvConfigWorkspace>;
/**
 * Schema for uv index entry configuration.
 */
export declare const UvIndexEntrySchema: z.ZodType<UvIndexEntry>;
/**
 * Schema for [tool.uv] section in pyproject.toml or uv.toml.
 */
export declare const UvConfigSchema: z.ZodType<UvConfig>;

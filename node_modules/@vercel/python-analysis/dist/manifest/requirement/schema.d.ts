...
import type { DependencySource, HashDigest, NormalizedRequirement } from './types';
/**
 * Schema for dependency source information (git, path, or index).
 * Used in [tool.uv.sources] in pyproject.toml.
 */
export declare const DependencySourceSchema: z.ZodType<DependencySource>;
/**
 ...
 */
export declare const NormalizedRequirementSchema: z.ZodType<NormalizedRequirement>;
/**
 * Schema for parsed hash digest for a requirement.
 * Format: algorithm:hash_value (e.g., "sha256:abc123...")
 */
export declare const HashDigestSchema: z.ZodType<HashDigest>;

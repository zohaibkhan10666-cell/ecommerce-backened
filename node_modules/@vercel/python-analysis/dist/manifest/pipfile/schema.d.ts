 ...
 */
export declare const PipfileDependencyDetailSchema: z.ZodType<PipfileDependencyDetail>;
/**
 * Schema for Pipfile dependency (string version specifier or detail object).
 */
export declare const PipfileDependencySchema: z.ZodType<PipfileDependency>;
/**
 * Schema for Pipfile source configuration.
 */
export declare const PipfileSourceSchema: z.ZodType<PipfileSource>;
/**
 * Schema for Pipfile.
 *
 ...
 */
export declare const PipfileLikeSchema: z.ZodType<PipfileLike>;
/**
 * Schema for Pipfile.lock _meta section.
 */
export declare const PipfileLockMetaSchema: z.ZodType<PipfileLockMeta>;
/**
 ...
 * call .passthrough() - the record part already allows additional keys.
 */
export declare const PipfileLockLikeSchema: z.ZodType<PipfileLockLike>;

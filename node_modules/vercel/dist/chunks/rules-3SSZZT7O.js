...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-3WF6K6R5.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-3WF6K6R5.js")).default(client, args);
    case "add":
      return (await import("./add-GWMRXCPO.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-ENVJZ4PJ.js")).default(client, args);
    case "rm":
      return (await import("./rm-RY7JBRD5.js")).default(client, args);
    case "update":
      return (await import("./update-QRLM425M.js")).default(client, args);
    default:
